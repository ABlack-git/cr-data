...
```
```{r}
data_per_capita <- read_csv("../data_for_model/data_per_capita.csv")
...
```{r}
data_rev_long <- data %>% pivot_longer(cols=c(tax_revenue, capital_revenue, non_tax_revenue), names_to = "revenue_type", values_to = "revenue")
